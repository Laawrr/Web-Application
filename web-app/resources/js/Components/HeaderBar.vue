...
<script setup>
import { ref } from 'vue';
import Notification from './Notification.vue'; // Import the new Notification component
</script>
...
fwb-navbar {
background-color: #008080; /* Teal for the navbar */
}
...
color: #ADD8E6; /* Light Blue for active link */
}

fwb-navbar-link:hover {
color: #FF7F50; /* Orange for hover effect */
}
</style>
