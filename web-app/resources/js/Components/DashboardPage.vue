...
/* Dashboard header */
  ...
  padding: 80px 20px; /* Reduced padding for better alignment */
  position: relative;
...
.dashboard-header h1 {
  ...
  position: relative;
  z-index: 2;
  margin: 0 0 20px 0; /* Space between the header and the search bar */
}
...
.search-bar input::placeholder {
  ...
  @media (max-width: 768px) {
    .dashboard-header {
      padding: 60px 20px; /* Less padding on smaller screens */
    }
    .dashboard-header h1 {
  ...
  @media (max-width: 480px) {
    .dashboard-header {
      padding: 50px 10px; /* Even less padding for very small screens */
    }
    .dashboard-header h1 {
  ...
  .card {
    background-color: #FFF; /* White for cards */
    padding: 1rem;
    border: 3px solid #ccc; /* Light border for box effect */
    box-shadow: none; /* No shadow for box-style look */
    margin: 1rem; /* Space between cards */
    display: flex;
    flex-direction: column;
    justify-content: space-between;
    height: 350px;
    width: 290px; /* Fixed width for box-style */
    text-align: left;
    position: relative;
  }
  ...
  .card-image {
    ...
    margin-bottom: 1rem; /* Space between image and the rest of the content */
  }

  .card:hover {
  transform: translateY(-5px); /* Lift the card slightly */
  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1); /* Add a shadow to elevate the card */
...
.card-image.clickable:hover {
  ...
  /* Button styling */
  button.primary {
    background-color: #008080; /* Teal for primary button */
    color: white;
  ...
  button.primary:active {
    background-color: #004949; /* Even darker teal on click */
  ...
  .delete-btn {
    ...
    color: #ff4d4d; /* Soft red for delete icon */
    cursor: pointer;
  ...
  .delete-btn:hover {
    color: #d80000; /* Darker red on hover */
    transform: scale(1.1); /* Slightly enlarge on hover */
  ...
  .floating-upload-btn:active {
    background-color: #004949; /* Even darker teal on click */
    transform: scale(0.95); /* Shrink slightly on click */
    box-shadow: 0 4px 10px rgba(0, 0, 0, 0.3); /* Smaller shadow on active click */
  }
